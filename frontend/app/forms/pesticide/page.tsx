...
export default function CreatePesticideFormPage() {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const response = await formsClient.createPesticideForm({
            ...
            router.push(`/forms/pesticide/${response.id}`);
        } catch (err) {
            ...
            <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="bg-white dark:bg-zinc-900 rounded-lg shadow p-6">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="pesticideName" className="block text-sm font-medium text-zinc-900 dark:text-zinc-50 mb-2">
                                Name of Pesticide
                            </label>
                            <input
                                id="pesticideName"
