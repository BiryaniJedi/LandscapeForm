...
export default function LawnFormDetailPage() {
    ...
    const [form, setForm] = useState<LawnForm | null>(null);
    ...
    useEffect(() => {
        const fetchForm = async () => {
            try {
                const data = await formsClient.getLawnForm(formId);
                setForm(data);
            } catch (err) {
                    ...
                    {form && (
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center">
                                    <input type="checkbox" checked={form.fert_only} disabled className="mr-2" />
